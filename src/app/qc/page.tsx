...
function redcapRecordUrl(base: string, studyId: string, page: string): string {
...
const CATEGORY_CONFIG = {
  consistency: { label: '重複欄位衝突', icon: ArrowLeftRight, color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-950/30',  border: 'border-purple-200 dark:border-purple-900' },
                          ...
                          <tr
                            ...
                            onClick={() => {
                              if (hasLink) {
                                ...
                                if (data?.redcapBaseUrl) window.open(redcapRecordUrl(data.redcapBaseUrl, f.studyId!, f.redcapPage!), '_blank');
                              }
                            }}
                          >
